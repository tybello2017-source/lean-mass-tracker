const CACHE='lean-mass-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./seed-data.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png'];
